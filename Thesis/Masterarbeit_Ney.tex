...
\subsubsection{Fazit}
Als Fazit kann man sagen dass man Referenzen gegenüber Zeigern wenn möglich bevorzugen soll und seinen Code so gestalten soll das die Verwendung von Zeigern überflüssig wird. Referenzen haben den Vorteil dass die Syntax mit dem Punkt Operator übersichtlicher wirkt, sicherer zu verwenden sind da eine Referenz immer auf ein gültiges Datenobjekt zeigt und Vorteile zeigen wenn es um kopier- Konstruktoren oder das Überladen von Operatoren geht.
\newpage
