...
Im folgendem Beispiel braucht man eine Funktion die jeweils 2 \textbf{int} und \textbf{double} Werte addieren kann. Im klassischen C müsste man 2 Funktionen deklarieren die sich jeweils in ihrem Namen unterscheiden, wohingegen man in C++ nochmal den gleichen Namen für die Funktion verwenden kann.
\begin{figure}[!htb]
...
\subsection{Arrays vs 'std::vector'}
