...
\place{Wien}
\kurzfassung{
In der Entwicklung von Eingebetten Systemen hat sich in den letzen Jahren einiges getan. Moderne Programmiersprachen wie C/C++ haben den Einzug in die embbeded Entwicklung gefunden und aufwendiges programmieren in Assembler sollte nur noch in wenigen Fällen die Ausnahme sein. Diese Master Arbeit beschäftigt sich haupsächlich mit der Frage welche Vorteile der Einsatz einer Objektorientierten Programmiersprache gegenüber einer funktionalen Programmiersprache hat.
Das Haupaugenmerk dieser Arbeit wird die Sinnhaftigkeit der Programmioersprache C++ in Kombination mit Microkontrollern stehen die einen nicht alt so großen Flash Speicher aufweisen könnnen.
